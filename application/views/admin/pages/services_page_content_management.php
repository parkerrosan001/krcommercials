<div class="container-fluid">
    <?php
    if (isset($_SESSION['cal_services_page_content_err'])) {
    ?>
        <div class="alert alert-danger"><?php echo $_SESSION['cal_services_page_content_err'] ?></div>
    <?php
    }
    ?>

    <?php
    if (isset($_SESSION['cal_services_page_content_succ'])) {
    ?>
        <div class="alert alert-success"><?php echo $_SESSION['cal_services_page_content_succ'] ?></div>
    <?php
    }
    ?>
    <?php
    if (isset($_SESSION['fl_services_page_content_err'])) {
    ?>
        <div class="alert alert-danger"><?php echo $_SESSION['fl_services_page_content_err'] ?></div>
    <?php
    }
    ?>

    <?php
    if (isset($_SESSION['fl_services_page_content_succ'])) {
    ?>
        <div class="alert alert-success"><?php echo $_SESSION['fl_services_page_content_succ'] ?></div>
    <?php
    }
    ?>
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Services Page Content Florida Branch</h3>
                </div>
                <form enctype="multipart/form-data" action="<?php echo base_url() ?>admin/services/updateFlServicesPageContent" method="POST">
                    <div class="card-body">
                    ...
                    <div class="card-footer text-right">
                        <input type="submit" value="Update Content" class="btn btn-primary" name="fl_services_content_updt_btn">
                    </div>
                </form>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Services Page Content California Branch</h3>
                </div>
                <form enctype="multipart/form-data" action="<?php echo base_url() ?>admin/services/updateCALServicesPageContent" method="POST">
                    <div class="card-body">
                        <div class="form-group">
                            <label>Page Heading</label>
                    ...
                    <div class="card-footer text-right">
                        <input type="submit" value="Update Content" class="btn btn-primary" name="cal_services_content_updt_btn">
                    </div>
                </form>
            </div>
        </div>
