    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 row m-0 mb-3 p-0">
                <div class="col-md-6">
                    <form action="<?php echo base_url() ?>FileSystem/searchFolderFiles" method="POST">
                ...
                <div class="col-md-2 col-6 text-right  mt-4 mt-md-0">
                    <form action="<?php echo base_url() ?>FileSystem/filterFolderFiles" method="POST">
                        <input type="hidden" value="<?php echo $folder_id; ?>" name="folder_id_field" id="folder_id_field" />
        ...
        <div class="row">
            <div class="col-md-4">
                <a href="<?php echo base_url() ?>FileSystem"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back to FileSystem</a>
            </div>
        </div>
        <div class="row mt-3">
                                    ...
                                    <div class="dropdown p-0">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right p-0">
                                            <ul class="link-list-plain no-bdr">
                                                ...
                                                ?>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'FileSystem/deleteSubFolder/' . $file->unique_id . '/' . $file->parrent_unique_id . '/viewFolder'; ?>" onclick="return confirm('Are you sure to delete this folder? All Files inside this folder will be lost.')">
                                                ...
                                                ?>
                                                    <li>
                                                        <a href="<?php echo base_url() . 'FileSystem/deleteFile/' . $file->unique_id . '/' . $file->parrent_unique_id . '/viewFolder'; ?>" onclick="return confirm('Are you sure to delete this file?')">
                                                            <i class="fa fa-trash" aria-hidden="true"></i>
                                                            <span>Delete</span>
                                                        </a>
                                                    </li>
        ...
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>FileSystem/uploadFiles" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" name="controller_field" id="controller_field" value="viewFolder">
                    <input type="hidden" value="<?php echo $folder_id; ?>" name="folder_id_field" id="folder_id_field" />
