        ...
        <div class="row">
            ...
            <div class="tab col-md-12 text-center mb-3 row m-0 p-0">
                <div class="col-md-6 p-0">
                    <a href="<?php echo base_url() ?>services"> <button class="tablinks">Project Services</button></a>
                </div>
                <div class="col-md-6 p-0">
                    <a href="<?php echo base_url() ?>services/skilledTradeServices"> <button class="tablinks active">Skilled Trade Services</button></a>
                </div>
            </div>
